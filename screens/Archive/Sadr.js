...
function Sadr({ navigation }) {
  ...
  const fetchPosts = () => {
    setIspaginated(true);
    const apiUrl = `https://fouadelwatan.net/api/archivesadr?page=${page}`;
      ...
      <>
        <View style={styles.ViewStatus}>
          <Text style={styles.textStatus}>
            {" "}
            العدد الإجمالى للأرشيف الصادر : {number}
          </Text>
        </View>
        {/* <TextInput
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <TouchableOpacity style={styles.itemStyle} activeOpacity={1}>
              ...
              <Text style={styles.text}>
                <Text style={styles.title}> تاريخ الصادر : </Text>
                {item.sadr_date}
              </Text>
              <Text style={styles.text}>
                <Text style={styles.title}> تاريخ الإسترجاع : </Text>
                {item.back_date}
              </Text>
              {/* <Text style={styles.text}>
