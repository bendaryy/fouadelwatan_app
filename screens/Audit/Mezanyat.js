...
function Mezanyat({ route, navigation }) {
  ...
  const { type, season, month, status } = route.params;
  ...
  const fetchPosts = () => {
    const apiUrl = `https://fouadelwatan.net/api/mezanya/${type}/${season}/${month}/${status}`;
    ...
    return (
        <>
          <View style={styles.ViewStatus}>
            <Text style={styles.textStatus}>سنة الميزانية : {season}</Text>
            <Text style={styles.textStatus}>شهر الميزانية : {month}</Text>
            <Text style={styles.textStatus}>حالة الميزانية : {status}</Text>
            <Text style={styles.textStatus}> عدد الميزانيات : {number}</Text>
          </View>
